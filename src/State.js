    ...
    render() {
        ...
        return (
            <div className="parent statehead">
                ...
                <div className="State">
                    <div>There has been a total of <span className="total">{state.confirmed}</span> confirmed cases in {this.props.state}. Out of which <span className="recovered">{state.recovered}</span> have been recovered and <span className="death">{state.deaths}</span> have died. {state.migrateother}
